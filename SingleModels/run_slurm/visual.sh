...
#SBATCH --output=/scratch/prsood/visual_single/logs/%N-%j.out # %N for node name, %j for jobID # Remember to mae logs-dir
...
wandb agent ddi/Visual_single/0o3wwkxr --count 20
