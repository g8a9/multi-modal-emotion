...
#SBATCH --output=/scratch/prsood/transformers_audio_single/logs/%N-%j.out # %N for node name, %j for jobID # Remember to mae logs-dir
...
wandb agent ddi/Audio_single/ayljcf9c --count 20
