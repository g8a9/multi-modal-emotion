...
def runModel( accelerator, df_train , df_val, df_test  ,param_dict , model_param):
    ...
    model = train_audio_network(model , [df_train_no_accum , df_train_accum], df_val, criterion , lr, epoch ,  weight_decay,T_max, Metric , patience , clip , epoch_switch , checkpoint )
