...
class TextAudioVideoDataset(Dataset):
    ...
    def __init__(self, df , max_len , feature_col1 , feature_col2 , feature_col3  , label_col , timings = None , speaker = None , bbox = 'bbox'):
    ...
    def __getitem__(self, idx): 
        ...
        return [self.texts[idx] , self.audio_path[idx] , {"vid_path" : self.video_path[idx] , "timings":self.timings[idx] , "speaker" :self.speaker[idx] , "bbox": self.bbox[idx]}] , np.array(self.labels[idx])
...
class VisualDataset(Dataset):
    ...
    """
    def __init__(self, df , feature_col , label_col , timings = None , speaker = None):
