...
#SBATCH --job-name=1MTLBertVideoMAE
...
#SBATCH --output=/scratch/prsood/1MTLBertVideoMAE/logs/%N-%j.out # %N for node name, %j for jobID # Remember to mae logs-dir
...
wandb agent ddi/BertVideoMAE_1MTL/py7t3xvb --count 20