...
#SBATCH --job-name=LateFusionBertVideoMAE
...
#SBATCH --output=/scratch/prsood/LateFusionBertVideoMAE/logs/%N-%j.out # %N for node name, %j for jobID # Remember to mae logs-dir
...
wandb agent ddi/BertVideoMAE_LateFusion/lsg1iws0 --count 20
