...
from .train_model.text_video_train import train_tv_network, evaluate_tv
from .models.text_video import  BertVideoMAE , collate_batch
import wandb
...
def runModel( accelerator, df_train , df_val, df_test  ,param_dict , model_param):
    ...
    model = train_tv_network(model , [df_train_no_accum , df_train_accum], df_val, criterion , lr, epoch ,  weight_decay,T_max, Metric , patience , clip , epoch_switch , checkpoint )
    evaluate_tv(model, df_test, Metric)
